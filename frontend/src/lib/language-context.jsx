...
const translations = {
  en: {
    ...
    smartSearch: 'Smart Matching Engine',
    smartSearchDesc: 'Intelligent GPS triage finds the nearest verified hospital based on live bed availability.',
    realTimeUpdates: 'Real-Time Updates',
    realTimeUpdatesDesc: 'Live bed and blood availability updates from hospitals via Socket.io connection.',
    blockchainVerifiedTitle: 'Admin Verified Facility',
    blockchainVerifiedDesc: 'Hospital infrastructure and bed capacity certified by Super Admin inspection.',
  ...
  hi: {
    ...
    smartSearch: 'स्मार्ट मैचिंग इंजन',
    smartSearchDesc: 'GPS और लाइव बेड उपलब्धता के आधार पर निकटतम सत्यापित अस्पताल तुरंत खोजें।',
    ...
    blockchainVerifiedTitle: 'प्रशासन द्वारा सत्यापित',
    blockchainVerifiedDesc: 'सुपर एडमिन निरीक्षण द्वारा अस्पताल अवसंरचना और बेड क्षमता 100% सत्यापित।',
