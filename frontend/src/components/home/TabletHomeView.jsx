        ...
        <div className="w-[50%] pl-6 pr-2 py-6 space-y-4 text-left flex flex-col justify-center shrink-0">
          ...
          <div className="flex items-center gap-3 text-[11px] font-semibold text-gray-600 dark:text-gray-400 pt-1">
            <span className="flex items-center gap-1">
              <CheckCircle className="h-3.5 w-3.5 text-emerald-600 fill-emerald-100" /> {t('verifiedHospitals')}
            </span>
            <span className="flex items-center gap-1">
              <CheckCircle className="h-3.5 w-3.5 text-emerald-600 fill-emerald-100" /> {t('realTimeUpdatesBadge')}
            </span>
            <span className="flex items-center gap-1">
              <CheckCircle className="h-3.5 w-3.5 text-emerald-600 fill-emerald-100" /> {t('support24x7Badge')}
            </span>
          </div>
        </div>
          ...
          <div className="grid grid-cols-4 gap-3">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[11px] font-semibold text-gray-500 leading-tight">{t('hospitalsBeds')}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[11px] font-semibold text-gray-500 leading-tight">{t('bloodBanksAvailable')}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[11px] font-semibold text-gray-500 leading-tight">{t('activeAmbulances')}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[11px] font-semibold text-gray-500 leading-tight">{t('emergencySupport')}</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    <h3 className="font-bold text-sm text-gray-900 dark:text-white">{t('goldenHourLost')}</h3>
            ...
            <Card className="bg-red-50/60 dark:bg-red-950/20 border-red-100 dark:border-red-900/30 shadow-xs rounded-2xl">
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    <h3 className="font-bold text-sm text-gray-900 dark:text-white">{t('noCentralSystem')}</h3>
                    <p className="text-[11px] text-gray-500 dark:text-gray-400 font-medium leading-relaxed">
                      {t('noCentralDesc')}
                    </p>
                  </div>
            ...
            <Card className="bg-red-50/60 dark:bg-red-950/20 border-red-100 dark:border-red-900/30 shadow-xs rounded-2xl">
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    <h3 className="font-bold text-sm text-gray-900 dark:text-white">{t('bloodShortage')}</h3>
                    <p className="text-[11px] text-gray-500 dark:text-gray-400 font-medium leading-relaxed">
                      {t('bloodShortageDesc')}
                    </p>
                  </div>
              ...
              <CardContent className="p-3.5">
                <div className="flex flex-col items-start gap-2.5">
                  ...
                  <div className="space-y-0.5">
                    <h3 className="font-bold text-xs text-gray-900 dark:text-white">{t('smartMatching')}</h3>
            ...
            <Card className="bg-white dark:bg-card border-gray-200/80 shadow-xs rounded-2xl">
              <CardContent className="p-3.5">
                <div className="flex flex-col items-start gap-2.5">
                  ...
                  <div className="space-y-0.5">
                    <h3 className="font-bold text-xs text-gray-900 dark:text-white">{t('realTimeUpdatesCard')}</h3>
                    <p className="text-[10px] text-gray-500 dark:text-gray-400 font-medium leading-tight">
            ...
            <Card className="bg-white dark:bg-card border-gray-200/80 shadow-xs rounded-2xl">
              <CardContent className="p-3.5">
                <div className="flex flex-col items-start gap-2.5">
                  ...
                  <div className="space-y-0.5">
                    <h3 className="font-bold text-xs text-gray-900 dark:text-white">{t('adminVerified')}</h3>
                    <p className="text-[10px] text-gray-500 dark:text-gray-400 font-medium leading-tight">
                      {t('adminVerifiedDesc')}
                    </p>
                  </div>
            ...
            <Card className="bg-white dark:bg-card border-gray-200/80 shadow-xs rounded-2xl">
              <CardContent className="p-3.5">
                <div className="flex flex-col items-start gap-2.5">
                  ...
                  <div className="space-y-0.5">
                    <h3 className="font-bold text-xs text-gray-900 dark:text-white">{t('routeOptimization')}</h3>
                    <p className="text-[10px] text-gray-500 dark:text-gray-400 font-medium leading-tight">
            ...
            <Card className="bg-white dark:bg-card border-gray-200/80 shadow-xs rounded-2xl">
              <CardContent className="p-3.5">
                <div className="flex flex-col items-start gap-2.5">
                  ...
                  <div className="space-y-0.5">
                    <h3 className="font-bold text-xs text-gray-900 dark:text-white">{t('donorNetwork')}</h3>
                    <p className="text-[10px] text-gray-500 dark:text-gray-400 font-medium leading-tight">
                      {t('donorNetworkDesc')}
                    </p>
                  </div>
            ...
            <Card className="bg-white dark:bg-card border-gray-200/80 shadow-xs rounded-2xl">
              <CardContent className="p-3.5">
                <div className="flex flex-col items-start gap-2.5">
                  ...
                  <div className="space-y-0.5">
                    <h3 className="font-bold text-xs text-gray-900 dark:text-white">{t('panIndiaCoverage')}</h3>
                    <p className="text-[10px] text-gray-500 dark:text-gray-400 font-medium leading-tight">
            ...
            <Card className="bg-white dark:bg-card border-gray-200/80 shadow-xs rounded-2xl">
              <CardContent className="p-3.5">
                <div className="flex flex-col items-start gap-2.5">
                  ...
                  <div className="space-y-0.5">
                    <h3 className="font-bold text-xs text-gray-900 dark:text-white">{t('supportRoundClock')}</h3>
                    <p className="text-[10px] text-gray-500 dark:text-gray-400 font-medium leading-tight">
            ...
            <div className="bg-red-600 text-white p-6 rounded-2xl flex flex-col justify-between shadow-lg">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-extrabold tracking-tight">{t('adminVerified')}</h3>
                </div>
                ...
                <ul className="space-y-2 text-xs font-semibold pt-2">
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 rounded-full bg-white/20 p-0.5" /> {t('superAdminVerified')}
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 rounded-full bg-white/20 p-0.5" /> {t('certifiedWardInventory')}
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 rounded-full bg-white/20 p-0.5" /> {t('adminVerified')}
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-card border border-gray-200 dark:border-gray-800 p-6 rounded-2xl flex items-center justify-between shadow-xs">
              <div className="space-y-3 max-w-[240px]">
                <div className="flex items-center gap-2.5">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white">{t('smartMatchingEngine')}</h3>
                </div>
      ...
      <section className="relative w-full overflow-hidden text-white my-4">
        <div className="relative w-full">
          ...
          <div className="absolute inset-0 container mx-auto px-6 max-w-5xl flex items-center justify-end gap-4 z-10">
            ...
            <Link to="/emergency">
              <Button size="sm" className="bg-red-600 hover:bg-red-700 text-white font-black px-4 py-4 text-xs rounded-xl shadow-xl transition-transform hover:scale-[1.03] shrink-0 border border-red-500 cursor-pointer">
                {t('searchNow')}
